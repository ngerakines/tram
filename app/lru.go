...
// NKG: This is based on the LRU implementation by Google. I've made a few
// minor modifications, but it is otherwise intact.
package app
...
func (lru *LRUCache) AddListener(listener chan string) {
	...
	lru.evictionListeners = append(lru.evictionListeners, listener)
}
